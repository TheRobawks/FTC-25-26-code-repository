...
@TeleOp
public class C_Main_Autonomous_Blue_Far extends OpMode {
            ...
            if(found == true){
                ...
                if(end_serch_timestamp+1.8+end_serch_timestamp-start_serch_timestamp<runtime.seconds()){
                    if(end_serch_timestamp+4+end_serch_timestamp-start_serch_timestamp>runtime.seconds()){
                        if(300 < motorFrontLeft.getCurrentPosition()) {
                            motorFrontLeft.setPower(-0.55);
                        }
                        if(300 < motorBackLeft.getCurrentPosition()) {
                            motorBackLeft.setPower(-0.55);
                        }
                        if(300 < motorFrontRight.getCurrentPosition()) {
                            motorFrontRight.setPower(-0.4);
                        }
                        if(300 < motorBackRight.getCurrentPosition()) {
                            motorBackRight.setPower(-0.4);
                        }
                        if(300 > motorFrontLeft.getCurrentPosition()) {
                            motorFrontLeft.setPower(0);
                ...
                if(simlify+3<runtime.seconds()){
                    if(simlify+10.3>runtime.seconds()){
                        if(2770 > motorFrontLeft.getCurrentPosition()) {
                            motorFrontLeft.setPower(0.55);
                        }
                        if(2770 > motorBackLeft.getCurrentPosition()) {
                            motorBackLeft.setPower(0.55);
                        }
                        if(5370 > motorFrontRight.getCurrentPosition()) {
                            motorFrontRight.setPower(0.4);
                        }   
                        if(5370 > motorBackRight.getCurrentPosition()) {
                            motorBackRight.setPower(0.4);
                        }
                        if(2770 < motorFrontLeft.getCurrentPosition()) {
                            motorFrontLeft.setPower(0);
                    ...
                    if(simlify+10.3<runtime.seconds()){
                        if(simlify+16.3>runtime.seconds()){
                            ...
                            //!!
                            if(3770+position > motorFrontLeft.getCurrentPosition()) {
                                motorFrontLeft.setPower(0.55);
                            }
                            if(1770-position < motorBackLeft.getCurrentPosition()) {
                                motorBackLeft.setPower(-0.55);
                            }
                            if(4370-position < motorFrontRight.getCurrentPosition()) {
                                motorFrontRight.setPower(-0.4);
                            }   
                            if(6370+position > motorBackRight.getCurrentPosition()) {
                                motorBackRight.setPower(0.4);
                            }
                            if(3770+position < motorFrontLeft.getCurrentPosition()) {
                                motorFrontLeft.setPower(0);
                    ...
                    if(simlify+16.3<runtime.seconds()){
                        if(simlify+18.3>runtime.seconds()){
                            if(distanceCM>2){
                                motorFrontLeft.setPower(0.55);
                                motorBackLeft.setPower(0.55);
                                motorFrontRight.setPower(0.4);
